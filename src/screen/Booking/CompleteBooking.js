...
const CompletedDetails = (props) => {
  ...
  return (
    <View style={styles.container}>
      <Header HeaderTittle={"Complete Booking"} />
          ...
          <View style={{ flex:1,flexDirection: 'row' , gap:10 ,marginHorizontal:20,}}>
                ...
                >
                  ...
                  >
                    <Image
                      ...
                      source={require("../Assets/icons8-message-48.png")}
                    />
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={{
            ...
            <View style={styles.container}>
              ...
              <View style={styles.section}>
                ...
                >
                  <View>
                    <Text style={styles.sectionTitle}>Work End Images</Text>
                  </View>
                  <View
                    style={{
                ...
                >
                  <View style={styles.modalContainer}>
                    <View style={styles.modalContent}>
                      <View style={styles.section}>
                        <Text style={styles.sectionTitle}>Edit Images</Text>
                        <View style={styles.imageContainer}>
                          <TouchableOpacity
                            onPress={() => handleImagePress(setCustomerImage1)}
                          >
                            <Image
                              source={
                                customerImage1
                          ...
                          <TouchableOpacity
                            onPress={() => handleImagePress(setCustomerImage2)}
                          >
                            <Image
                              source={
                                customerImage2
