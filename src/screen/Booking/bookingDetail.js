...
<View>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Customer Image</Text>
        <View style={styles.imageContainer}>
          <TouchableOpacity onPress={() => handleImagePress(setCustomerImage1)}>
            <Image
              source={customerImage1 ? { uri: customerImage1 } : require('../../assets/images/placeholder.webp')}
              style={styles.image}
            />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleImagePress(setCustomerImage2)}>
            <Image
              source={customerImage2 ? { uri: customerImage2 } : require('../../assets/images/placeholder.webp')}
              style={styles.image}
            />
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Work Start Image</Text>
        <View style={styles.imageContainer}>
          <TouchableOpacity onPress={() => handleImagePress(setWorkStartImage1)}>
            <Image
              source={workStartImage1 ? { uri: workStartImage1 } : require('../../assets/images/placeholder.webp')}
              style={styles.image}
            />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleImagePress(setWorkStartImage2)}>
            <Image
              source={workStartImage2 ? { uri: workStartImage2 } : require('../../assets/images/placeholder.webp')}
              style={styles.image}
            />
          </TouchableOpacity>
        </View>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>Job Completed Image</Text>
        <View style={styles.imageContainer}>
          <TouchableOpacity onPress={() => handleImagePress(setJobCompletedImage1)}>
            <Image
              source={jobCompletedImage1 ? { uri: jobCompletedImage1 } : require('../../assets/images/placeholder.webp')}
              style={styles.image}
            />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => handleImagePress(setJobCompletedImage2)}>
            <Image
              source={jobCompletedImage2 ? { uri: jobCompletedImage2 } : require('../../assets/images/placeholder.webp')}
              style={styles.image}
            />
          </TouchableOpacity>
        </View>
